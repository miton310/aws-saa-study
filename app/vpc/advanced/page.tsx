...
import VPCAdvancedStepper from '@/components/visualizations/VPCAdvancedStepper'
import QuizSection from '@/components/QuizSection'

export default function VPCAdvancedPage() {
  const cat = getCategoryBySlug('vpc')!
  const diff = getDifficultyBySlug('advanced')!
  const content = getContent('vpc', 'advanced')!
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center justify-between border-t border-gray-200 pt-6">
        <Link href="/vpc/intermediate" className="text-gray-500 hover:text-gray-700 text-sm font-medium">
          ← 中級に戻る
        </Link>
        <Link
          href="/"
