...
import EC2AdvancedStepper from '@/components/visualizations/EC2AdvancedStepper'
import QuizSection from '@/components/QuizSection'

export default function EC2AdvancedPage() {
  const cat     = getCategoryBySlug('ec2')!
  const diff    = getDifficultyBySlug('advanced')!
  const content = getContent('ec2', 'advanced')!
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center justify-between border-t border-gray-200 pt-6">
        <Link href="/ec2/intermediate" className="text-gray-500 hover:text-gray-700 text-sm font-medium">
          ← 中級に戻る
        </Link>
        <Link
          href="/ec2"
