...
import EC2BeginnerStepper from '@/components/visualizations/EC2BeginnerStepper'
import QuizSection from '@/components/QuizSection'

export default function EC2BeginnerPage() {
  const cat     = getCategoryBySlug('ec2')!
  const diff    = getDifficultyBySlug('beginner')!
  const content = getContent('ec2', 'beginner')!
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center justify-between border-t border-gray-200 pt-6">
        <Link href="/ec2" className="text-gray-500 hover:text-gray-700 text-sm font-medium">
          ← EC2 難易度選択に戻る
        </Link>
        <Link
          href="/ec2/intermediate"
